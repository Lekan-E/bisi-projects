...
Unsupervised K-Means clustering model that segments mall customers by annual income and
spending score, modularized from `Unsupervised_Clustering_Solution.ipynb`.
...
curve peaks cleanly at k=6, matching the notebook's own conclusion for this feature set — see
the printed Elbow/Silhouette tables and `elbow_plot.png` / `silhouette_plot.png`.
